...
public class QuestionManager {
    ...
    /**
     * A class for fetching questions from an API over the internet.
     */
    private final QuestionApiManager questionApiManager;

    public QuestionManager(QuestionApiManager questionApiManager) {
    ...
    /**
     * Adds the question to this {@link QuestionManager}. Once added it can appear within question sets generated by using {@link #createNextQuestionSet(int, IQuestionSetCallback)}.
     *
    ...
    /**
     * Sets the money values for questions. If more questions are created (see {@link #createNextQuestionSet(int, IQuestionSetCallback)}) than defined in this array, the last value will be used.
     *
     ...
     * If internet is connected and the required {@link QuestionApiManager} is provided in the constructor, questions will be fetched from it instead of the questions stored within this manager.
     * <br/><br/>
     * Callback with two {@link ArrayList}s of questions, or empty {@link ArrayList}s if no difficulty sequence was defined. See {@link QuestionManager#appendDifficultySeq(int, Difficulty)}
     *
     * @param count The number of questions to return.
     */
    public void createNextQuestionSet(int count, IQuestionSetCallback callback) {

        // We have a valid question api manager and internet access.
        if (questionApiManager != null && questionApiManager.hasInternetAccess()) {
            questionApiManager.createNextQuestionSet(this, count, callback);
            return;
        }
        ...
        List<GameQuestion> questionList1 = new ArrayList<>();
        List<GameQuestion> questionList2 = new ArrayList<>();


        if (difficultySequence.isEmpty()) {
            callback.onQuestionSetCreated(questionList1, questionList2);
            return;
        }
        ...
        for (int i = 0; i < count; i++) {
            ...
            addUnique(questionList1, questionsOfDifficulty, value, isSafe);
            addUnique(questionList2, questionsOfDifficulty, value, isSafe);
    ...
    private void addUnique(List<GameQuestion> questionList, List<Question> questionsOfDifficulty, double value, boolean isSafe) {
    ...
    /**
     * Adds all the questions specified into this {@link QuestionManager}. Once added they can appear within question sets generated by using {@link #createNextQuestionSet(int, IQuestionSetCallback)}.
     *
    ...
    /**
     * Returns a String representing a JSON object containing an array of all the questions of the specified difficulty loaded into this QuestionManager instance.
     */
    ...
    /**
     * Returns a new List of all the questions within this QuestionManager.
     */
    ...
    public List<DifficultyLevel> getDifficultySequences() {
        return difficultySequence;
    }

    public Set<Integer> getSafeMoneyIndices() {
        return safeMoneyIndices;
    }

    public List<Double> getQuestionValues() {
